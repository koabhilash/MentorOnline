...
class FullTaggingRequestDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_full_tagging_request)
        ...
        var taggingEmail = sharedPreferences.getString("email", null)

        if (taggingEmail == null) {
            taggingEmail = intent.getStringExtra("signup_email")
            if (taggingEmail != null) {
                sharedPreferences.edit().putString("email", taggingEmail).apply()
            }
        }
    ...
    private fun fetchTaggingRequestDetails(
        studentName: String,
        regNumber: String,
        subject: String,
        mentorName: String,
        ...
        Thread {
            try {
                val url = URL("http://10.46.158.55/online%20mentor/tagging_full_request.php")
                ...
                val jsonParam = JSONObject().apply {
                    ...
                    put("tagging_email", taggingEmail)
                }
