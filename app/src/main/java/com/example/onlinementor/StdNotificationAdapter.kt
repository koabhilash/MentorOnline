...
class StdNotificationAdapter(
    private val context: Context,
    private val requestList: List<Map<String, String>>,
    private val email: String // Adding email as a parameter to pass along
) : RecyclerView.Adapter<StdNotificationAdapter.RequestViewHolder>() {

    // ViewHolder class for StdNotificationAdapter
    ...
    // Inflating the layout for the item view
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RequestViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_std_notification, parent, false)
    ...
    override fun onBindViewHolder(holder: RequestViewHolder, position: Int) {
        ...
        val bgColor = when (mentorStatus) {
            "accepted" -> Color.parseColor("#4CAF50") // green
        ...
        holder.btnView.setOnClickListener {
            val intent = Intent(context, StdNotifiDetails::class.java).apply {
                // Pass the email along with the other data
                ...
                putExtra("email", email)  // Include email here
            }
