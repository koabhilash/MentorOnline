...
class HistTaggingReqAdapter(
    private val context: Context,
    private val requestList: List<Map<String, String>>
) : RecyclerView.Adapter<HistTaggingReqAdapter.RequestViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RequestViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_tagging_request_hist, parent, false)
    ...
    override fun onBindViewHolder(holder: RequestViewHolder, position: Int) {
        ...
        holder.btnView.setOnClickListener {
            val intent = Intent(context, HistTaggingReqDetails::class.java).apply {
