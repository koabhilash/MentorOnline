...
class HistTaggingRequest : AppCompatActivity() {

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: HistTaggingReqAdapter
    private val requestList = mutableListOf<Map<String, String>>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tagging_request_hist)
    ...
    private fun fetchTaggingRequests(email: String) {
        val url = "http://10.46.158.55/online%20mentor/fetch_tagging_request_hist_item.php"
        ...
        Thread {
            try {
                ...
                if (jsonResponse.getBoolean("success")) {
                    ...
                    runOnUiThread {
                        adapter = HistTaggingReqAdapter(this, requestList)
